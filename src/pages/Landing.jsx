...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {JOURNEY_STEPS.map((step, i) => (
            <Card key={step.title} hover className="p-6 relative">
              <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-brand-blue-600 to-brand-purple-600 flex items-center justify-center text-white mb-4 shadow-soft">
                <step.icon size={20} />
              </div>
      ...
      {/* For students */}
      <section id="students" className="bg-brand-ink-50/50 border-y border-brand-ink-100">
          ...
          {TESTIMONIALS.map((t) => (
            <Card key={t.name} hover className="p-6">
              ...
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-brand-blue-500 to-brand-purple-500 flex items-center justify-center text-white text-sm font-semibold">
      ...
      {/* FAQ */}
      <section id="faq" className="bg-brand-ink-50/50 border-y border-brand-ink-100">
      ...
      <section className="container-app py-16 lg:py-24">
        <Card className="p-10 sm:p-16 text-center bg-gradient-to-br from-brand-blue-600 to-brand-purple-600 border-none">
